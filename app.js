...
status_btns = {"Active" : `<button type="button" class='btn project-btn mr-1 mt-auto btn-sm btn-outline-success' style="pointer-events: none">Active</button>`,
  ...
  $('html,body').animate({scrollTop: aTag.offset().top},'slow');
    ...
    $(document).ready(function() {
      ...
      $('#projectModal').on('show.bs.modal', function (event) {
        ...
        var d = loadFile("json/projects.json");
        //console.log(data);
